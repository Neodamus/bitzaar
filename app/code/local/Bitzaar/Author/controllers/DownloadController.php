...
class Bitzaar_Author_DownloadController extends Mage_Downloadable_DownloadController {

    /**
     * Modified link action -- Mage/Downloadable/DownloadsController -- need to change base path used for downloading files
     */
        ...
        if ($status == Mage_Downloadable_Model_Link_Purchased_Item::LINK_STATUS_AVAILABLE
            ...
            if ($linkPurchasedItem->getLinkType() == Mage_Downloadable_Helper_Download::LINK_TYPE_URL) {
                ...
                $resource = Mage::helper('downloadable/file')->getFilePath(
                    //Mage_Downloadable_Model_Link::getBasePath(), $linkPurchasedItem->getLinkFile()    -- core functionality
					Bitzaar_Author_Model_Author::getBasePath(), $linkPurchasedItem->getLinkFile()
                );
